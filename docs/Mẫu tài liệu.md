# [YOUR_LIBRARY_NAME] <p align="left">
    <a href="[URL_TO_YOUR_CI_WORKFLOW]"><img alt="Build Status" src="[URL_TO_YOUR_BUILD_BADGE]"></a> 
    <a href="[URL_TO_MAVEN_CENTRAL_OR_JITPACK_PAGE]"><img alt="Maven Central/Jitpack" src="[URL_TO_YOUR_VERSION_BADGE]"></a>
    <a href="[URL_TO_YOUR_LICENSE_FILE]"><img alt="License" src="[URL_TO_YOUR_LICENSE_BADGE]"></a>
    <img alt="API" src="[URL_TO_YOUR_MIN_API_BADGE]"> <a href="[URL_TO_YOUR_CODE_QUALITY_REPORT]"><img alt="Code Quality" src="[URL_TO_YOUR_CODE_QUALITY_BADGE]"></a> <a href="https://android-arsenal.com/details/1/[YOUR_ANDROID_ARSENAL_ID]"><img alt="Android Arsenal" src="https://img.shields.io/badge/Android%20Arsenal-YourLibraryName-brightgreen.svg?style=flat" /></a> <a href="http://makeapullrequest.com"><img alt="PRs Welcome" src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square"></a>
</p>

**[YOUR_LIBRARY_NAME]** là một thư viện Android [mô tả ngắn gọn về loại thư viện, ví dụ: "linh hoạt và dễ sử dụng để hiển thị...", "giúp đơn giản hóa việc...", "cung cấp hiệu ứng..."] được viết bằng [Kotlin/Java].
